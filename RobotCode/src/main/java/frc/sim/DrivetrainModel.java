...
class DrivetrainModel {
    ...
    public DrivetrainModel(){
        ...
        modules.add(new SwerveModuleModel(Constants.FL_WHEEL_MOTOR_CANID,Constants.FL_AZMTH_MOTOR_CANID,Constants.FL_AZMTH_ENC_IDX, Constants.FL_ENCODER_MOUNT_OFFSET_RAD, Constants.INVERT_WHEEL_DIRECTION[Constants.FL]));
        modules.add(new SwerveModuleModel(Constants.FR_WHEEL_MOTOR_CANID,Constants.FR_AZMTH_MOTOR_CANID,Constants.FR_AZMTH_ENC_IDX, Constants.FR_ENCODER_MOUNT_OFFSET_RAD, Constants.INVERT_WHEEL_DIRECTION[Constants.FR]));
        modules.add(new SwerveModuleModel(Constants.BL_WHEEL_MOTOR_CANID,Constants.BL_AZMTH_MOTOR_CANID,Constants.BL_AZMTH_ENC_IDX, Constants.BL_ENCODER_MOUNT_OFFSET_RAD, Constants.INVERT_WHEEL_DIRECTION[Constants.BL]));
        modules.add(new SwerveModuleModel(Constants.BR_WHEEL_MOTOR_CANID,Constants.BR_AZMTH_MOTOR_CANID,Constants.BR_AZMTH_ENC_IDX, Constants.BR_ENCODER_MOUNT_OFFSET_RAD, Constants.INVERT_WHEEL_DIRECTION[Constants.BR]));
